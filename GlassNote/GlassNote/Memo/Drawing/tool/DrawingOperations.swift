...
public struct AddShapeOperation: DrawingOperation {
  ...
  public init(shape: Shape) {
    ...
    public func apply(shapeManager: ShapeManager) {
        shapeManager.addShape(shape: shape)
  }

  public func revert(shapeManager:ShapeManager) {
      shapeManager.removeShape(shape: shape)
  }
}
...
public struct ChangeTransformOperation: DrawingOperation {
  ...
  public func apply(shapeManager:ShapeManager) {
    shape.transform = transform
      shapeManager.updateShape(shape: shape)
  }
