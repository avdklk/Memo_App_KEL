...
public protocol DrawingTool: AnyObject {
     ...
     */
    func activate(shapeUpdater: DrawsanaViewShapeUpdating, shapeManager: ShapeManager)
    //
    //    /// This tool has become deselected. The default implementation does nothing.
    func deactivate(shapeManager: ShapeManager)
    ...
    /// 기본 구현은 아무 동작도 하지 않습니다.
    func apply(shapeManager: ShapeManager, userSettings: UserSettings)
